...
interface Exports {
    ...
    blst_keygen: (out_SK: I32, IKM: I32, IKM_len: I32, info: I32, info_len: I32) => void;
    ...
    blst_hash_to_g1: (out_p1: I32, msg: I32, msg_len: I32, DST: I32, DST_len: I32, aug: I32, aug_len: I32) => void;
    ...
    blst_hash_to_g2: (out_p2: I32, msg: I32, msg_len: I32, DST: I32, DST_len: I32, aug: I32, aug_len: I32) => void;
    // void blst_pairing_init(blst_pairing *new_ctx, bool hash_or_encode, const byte *DST DEFNULL, size_t DST_len DEFNULL);
    blst_pairing_init: (out: I32, hash_or_encode: I32, DST: I32, DST_len: I32) => void;
    ...
    blst_pairing_chk_n_aggr_pk_in_g1: (ctx: I32, pk_p1a: I32, pk_grpchk: I32, sig_p2a: I32, sig_grpchk: I32, msg: I32, msg_len: I32, aug: I32, aug_len: I32) => I32;
    ...
    //     const byte *aug DEFNULL,
    //     size_t aug_len DEFNULL);
    blst_pairing_chk_n_aggr_pk_in_g2: (ctx: I32, pk_p2a: I32, pk_grpchk: I32, sig_p1a: I32, sig_grpchk: I32, msg: I32, msg_len: I32, aug: I32, aug_len: I32) => I32;
    ...
    //     const byte *aug DEFNULL,
    //     size_t aug_len DEFNULL);
    blst_core_verify_pk_in_g1: (pk_p1a: I32, sig_p2a: I32, hash_or_encode: I32, msg: I32, msg_len: I32, DST: I32, DST_len: I32, aug: I32, aug_len: I32) => I32;
...
export class BlstWrapper {
    ...
    p1_uncompress(inp: Uint8Array): Uint8Array {
        ...
        vmIn.set(inp);
        const err = this.api.blst_p1_uncompress(
            vmOut.byteOffset,
            vmIn.byteOffset
        );
        if (err !== Err.SUCCESS) {
    ...
    p2_uncompress(inp: Uint8Array): Uint8Array {
        ...
        vmIn.set(inp);
        const err = this.api.blst_p2_uncompress(
            vmOut.byteOffset,
            vmIn.byteOffset
        );
        if (err !== Err.SUCCESS) {
...
class Allocator {
    ...
    allocateFrame(l0: number, l1: number, l2: number): [number, [Uint8Array, Uint8Array, Uint8Array]];
    allocateFrame(l0: number, l1: number, l2: number, l3: number): [number, [Uint8Array, Uint8Array, Uint8Array, Uint8Array]];
    allocateFrame(l0: number, l1: number, l2: number, l3: number, l4: number): [number, [Uint8Array, Uint8Array, Uint8Array, Uint8Array, Uint8Array]];
    allocateFrame(l0: number, l1: number, l2: number, l3: number, l4: number, l5: number): [number, [Uint8Array, Uint8Array, Uint8Array, Uint8Array, Uint8Array, Uint8Array]];
...
export const Blst = new BlstWrapper(
    (
        await (async () => {
