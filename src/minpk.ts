...
export class Signature {
    ...
    aggregateVerify(scheme: Scheme, ...pairs: [PublicKey, Uint8Array][]): boolean {
        ...
        return Blst.core_aggregate_verify_g1(this._point, true, verifyPairs, true, true, getSuite(scheme, 2));
    }
    ...
    verify(scheme: Scheme, pk: PublicKey, msg: Uint8Array): boolean {
        ...
        return Blst.core_verify_pk_in_g1(pk._point, this._point, true, msg, getSuite(scheme, 2), aug);
    }
